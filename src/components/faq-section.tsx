  ...
  const faqs = [
    {
      ...
      answer:
        "NeyroMax — AI-помощник для разработчиков. Вы описываете задачу на русском или английском языке, а нейросеть генерирует готовый код, объясняет его и помогает с отладкой.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "NeyroMax использует одну из лучших AI-моделей для кода. Для большинства стандартных задач код работает с первого раза. Для сложных проектов рекомендуем итеративный подход: уточняйте требования в диалоге.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Да, для работы с чатом нужно войти по номеру телефона. Это занимает 30 секунд — вводите номер, получаете SMS с кодом, и сразу начинаете работать.",
    },
  ]
